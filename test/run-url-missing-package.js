...
new Promise((resolve, reject) => {
  const mainURL = fileURL(path.resolve('test', 'hello-world-missing-package', 'index.html'));
  const outputRegex = /opened (.*)test\/hello-world-missing-package\/index\.html in new window/;
